function q = spm_prctile(x,p)
% spm_prctile(x,p): calculate the p percentile of x.
% FORMAT q=spm_prctile(x,p)
% Input:
...
% @(#)spm_prctile.m	1.1 02/11/29
% Based on spmd_prctile.m 1.3 Wen-Lin Luo 02/10/03
